...
const Menu = ({ data, isOpen, onClose }) => {
  return (
    <>
      ...
      ></div>
      <div
        className={`fixed left-0 top-0 w-60 h-screen bg-white p-1 flex flex-col gap-3 rounded-lg z-30 pt-5 border-r shadow-xl transform transition-transform ${
          isOpen ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        <div className="flex items-center gap-x-2 px-3 mx-3 mb-2">
          <img src="/public/logo.svg" alt="Logo" className="h-16" />
